...
class _PublishSupplyScreenState extends State<PublishSupplyScreen> {
  ...
  Future<void> _pickAndCropImage(ImageSource source) async {
    try {
      ...
      final croppedFile = await ImageCropper().cropImage(
        ...
        compressQuality: 80,
        uiSettings: [
          AndroidUiSettings(toolbarTitle: '裁剪封面', toolbarColor: Colors.orange, toolbarWidgetColor: Colors.white, initAspectRatio: CropAspectRatioPreset.ratio16x9, lockAspectRatio: true),
  ...
  Future<void> _handlePublish() async {
    ...
    await MockAPI.publishSupply(newSupply, coverFile: _coverImage);
        ...
        child: Padding(
          ...
          child: ElevatedButton(
            ...
            child: _isPublishing
                ...
                : const Text('发布供给', style: TextStyle(fontSize: 16)),
          ),
        ),
      ),
    );
